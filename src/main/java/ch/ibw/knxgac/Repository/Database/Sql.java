...
//      INSERT INTO Customers SET ID=2, FirstName='User2';
    ...
    private <T> String sqlCreateTable(T object) {
        // CREATE TABLE Persons (PersonID int, LastName varchar(255), FirstName varchar(255), Model.Address varchar(255), City varchar(255));
        String className = otb.getObjectName(object);
     ...
     * @return
     */
    public <T> ArrayList<T> select(T filter) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, SQLException, InstantiationException {
    ...
    @Override
    public <T> boolean update(T object)  throws SQLException {
        return false;
    }

    @Override
    public <T> boolean delete(T object) throws SQLException {
        return false;
    }
